...
public class LusitaniaTravelBDHelper extends SQLiteOpenHelper {
    ...
    private static final String RESERVA_TIPO_QUARTO = "tipoquarto";
    private static final String RESERVA_NUMERO_NOITES = "numeronoites";
    private static final String RESERVA_NUMERO_CAMAS = "numerocamas";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String sqlCreateReservaTable = "CREATE TABLE " + TABLE_RESERVA +
                ...
                RESERVA_TIPO_QUARTO + " TEXT, " +
                RESERVA_NUMERO_NOITES + " INT, " +
                RESERVA_NUMERO_CAMAS + " INT);";
    ...
    public void adicionarReservaBD(Reserva reserva) throws SQLException {
        ...
        values.put(RESERVA_TIPO_QUARTO, reserva.getTipoQuarto());
        values.put(RESERVA_NUMERO_NOITES, reserva.getNumeroNoites());
        values.put(RESERVA_NUMERO_CAMAS, reserva.getNumeroCamas());
    ...
    public ArrayList<Reserva> getAllReservasBD() {
        ...
        Cursor cursor = this.db.query(TABLE_RESERVA, new String[]{RESERVA_ID, RESERVA_TIPO, RESERVA_CHECKIN, RESERVA_CHECKOUT, RESERVA_NUMERO_QUARTOS, RESERVA_NUMERO_CLIENTES, RESERVA_VALOR, RESERVA_CLIENTE_ID,
                RESERVA_FUNCIONARIO_ID, RESERVA_FORNECEDOR_ID, RESERVA_ESTADO, RESERVA_TIPO_QUARTO, RESERVA_NUMERO_NOITES, RESERVA_NUMERO_CAMAS}, null, null, null, null, null);
